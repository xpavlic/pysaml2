...
from saml2.sigver import SignatureError, TRIPLE_DES_CBC, RSA_OAEP_MGF1P, XMLSEC_SESSION_KEY_URI_TO_ALG
...
class Entity(HTTPBase):
    ...
    def _encrypt_assertion(
        ...
        :param encrypt_assertion_key_type: session key algorithm used when encrypting assertion
